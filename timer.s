//
// timer.s  Timer Routines: RTC 
//
.syntax unified
.data
CM_PER_BASE              = 0x44e00000
CM_RTC_RTC_CLKCTRL       = 0x0  // spruh73l 8.1.12.6.1  was 0x800
CM_RTC_CLKSTCTRL         = 0x4  // spruh73l 8.1.12.6.2  was 0x804
...
rtc_isr:
    ...
    ldr r2, [r0, HOURS_REG]
    str r2, [r1]
    ldr r1, =irq_count        // increment counter, C variable
    ldr r2, [r1]
    add r2, r2, #0x1
    str r2, [r1]
